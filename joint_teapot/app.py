...
def JOJ3_scoreboard(
    ...
    repo_path: str = Argument(
        "",
        help="path to gitea repo folder to push scoreboard file (as well as the destination to clone remote repo if --clone-from is specified)",
    ),
    ...
    tea.pot.gitea.JOJ3_scoreboard(
        scorefile_path, repo_path, scoreboard_file_name, remote_repo
    )
